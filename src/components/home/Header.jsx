        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 md:gap-4">
            ...
            <button
              ...
              className="hidden sm:block text-[#0475DC] hover:bg-[#0475DC]/10 p-2 rounded-full"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button
              ...
              className="hidden sm:block bg-[#0475DC] text-white px-4 py-1 rounded-full hover:bg-[#0475DC]/90"
            >
              Get Premium
            </button>
            <img
